...
public class TestCRUD {
    ...
    public void testCreateAlbum() {
        ...
        requestBody.put("title", "Butterfly");
        requestBody.put("description", "Ini adalah Album Butterfly");
    ...
    public void testUpdateAlbum() {
        ...
        requestBody = new JSONObject();
        requestBody.put("title", "album Butterfly update");
        requestBody.put("description", "ini adalah album Butterfly yang telah di update");
